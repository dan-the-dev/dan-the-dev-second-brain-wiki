...
## Chi è
Consulente esterno di Qmates, partner di [[fabio-fortini|Fabio Fortini]]. Entra nel team Muffin come sviluppatore di rinforzo, affiancando [[alessia|Alessia]] sulle feature e partecipando ai momenti tecnici del team (stand-up, tech ketchup, per rotation, testing).

## Contesto delle interazioni
Gianni è più orientato all'execution tecnica mentre Fabio è più orientato ai processi/organizzazione. Insieme coprono sia il codice sia la cultura. Dan lo coinvolge nei tavoli tecnici e nel per rotation del supporto.
