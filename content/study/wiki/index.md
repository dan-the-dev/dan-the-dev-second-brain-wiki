...
Dal 2026-08-22, l'archivio cresce anche per aggiunta manuale: 2 articoli il 2026-08-22 tramite il flusso "Online articles study draft" e 1 video il 2026-08-27, con le rispettive pagine persona per gli autori non presenti nell'import originale (Ivett Ördög, Wes Kao, Giuseppe Funicello), integrati nelle pagine Topic pertinenti (`ai`, `software-development`, `technical-excellence`, `leadership`, `communication`, `tech-lead`, `technology`). Il 2026-09-22 si sono aggiunti altri 2 articoli — *The Economic Benefit of Refactoring* (Giles Edwards-Alexander) e *TDD inside the agent loop* (Birgitta Böckeler), entrambi dalla serie *Exploring Generative AI* di martinfowler.com — i primi due contenuti dell'intero archivio studiati per intero con appunti personali reali (`status: studied`), non solo catturati o marcati "da leggere"; hanno integrato con nuove sezioni i topic [[topics/refactoring|Refactoring]], [[topics/tdd|TDD]] e [[topics/ai-development|AI Development]]. Il totale è ora di **80 contenuti con concetto di studio**. La sessione del 2026-08-27 ha inoltre corretto un errore di trascrizione presente nell'import originale che confondeva sistematicamente "Claude" con "Cloud" in alcuni contenuti relativi a Claude Code e Claude Cowork (vedi [[recent-changes|Ultime Modifiche]] per il dettaglio). Questa distinzione fra import storico Recall e aggiunte manuali successive resta visibile in [[by-type|By Type]]; [[knowledge-archive|Archivio Recall importato]] documenta solo l'import originale del 2026-08-19 e non viene aggiornato con le aggiunte successive.
...
- [[by-type|By Type]] — tutti gli 80 contenuti organizzati per tipo (book, article, video, conference, podcast, course), con i topic associati
- [[completed|Completati]] — elenco alfabetico completo degli 80 contenuti compilati (senza timeline cronologica per la maggior parte: le date di studio non erano recuperabili dall'export originale)
