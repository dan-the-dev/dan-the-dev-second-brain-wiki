...
- [[by-type|By Type]] — tutti i 78 contenuti organizzati per tipo (book, article, video, conference, podcast, course), con i topic associati
- [[completed|Completati]] — elenco alfabetico completo dei 78 contenuti compilati (senza timeline cronologica per la maggior parte: le date di studio non erano recuperabili dall'export originale)
